...
$(document).ready(function () {
  ...
  async function renderCocktailInformation(
    ...
    let sanitizedCocktailName = cocktails.replace(/[^\w]+/g, "-");
    let replacedCocktailName = sanitizedCocktailName + uniqueID
    let uniqueFavBtnTag = sanitizedCocktailName + uniqueID + "fav"
  ...
  const fetchCocktailName = async () => {
    ...
    for (i = 0; i < data.length; i++) {
      ...
      let youtubeApiKey = "&key=AIzaSyBVFFMfKK869oKYuUxrdi9D_r9u80idGDs";
